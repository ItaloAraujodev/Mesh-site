    ...
    return (
        <section id='home' className="w-full relative h-screen 360:h-screen md:h-screen bg-saturation-preto z-0" >
            <div className='flex items-center justify-center mb-4 z-10'>
                <div className="w-full h-[90%] 360:h-[70%] flex justify-center absolute m-auto top-0 left-0 right-0 bottom-0">
                    <img src={espaco} alt="Imagem do espaço" draggable="false" className='object-cover'/>
                </div>
                <div data-aos="" className="w-[50%] h-[50%] 360:w-[80%] text-white text-center absolute m-auto top-0 left-0 right-0 bottom-24 360:bottom-0">
