...
export default function Diferencial() {
  return (
      ...
      <div id='inte' className="w-full h-full bg-gradient-to-r from-blue-500 to-[#2a396b] py-1">
        <div className="w-full h-full bg-[#0E192A] text-white flex flex-col items-center py-20">
          ...
          <div className="md:grid md:grid-cols-10 md:w-[60%] gap-3 360:flex 360:flex-col 360:w-[90%]">
            <div className="border-[0.5px] border-white/40 rounded-xl relative col-span-6 h-[350px] ">
            ...
            <div className="border-[0.5px] border-white/40 rounded-xl relative col-span-4 ">
            ...
            <div className="border-[0.5px] border-white/40 rounded-xl relative col-span-10 h-[350px]">
              <div className="md:w-2/3 360:w-full space-y-2 py-2 px-4 ">
            ...
            <div className="border-[0.5px] border-white/40 rounded-xl relative col-span-5 h-[350px]">
