...
export default function Juntar() {
    return (
        <div className="w-full h-[45rem] pb-1 bg-gradient-to-r from-line-linear-azul to-line-linear-rosa ">
                ...
                <div className="flex flex-col justify-center items-center">
                    ...
                    <div className="w-full flex justify-center items-center gap-8">
                        ...
                        {imgsJuntar.map((item, index) => (
                            <div key={index} className="w-[18rem] h-[21rem] py-[2px] px-[2px] mt-12 rounded-[10px] bg-gradient-to-bl from-saturation-green to-saturation-azul-claro tra hover:bg-gradient-to-t hover:from-line-linear-azul hover:to-line-linear-rosa">
                                <div className="w-full h-full bg-linear-escuro rounded-[10px] overflow-hidden bg-cover bg-no-repeat">
                                    ...
                                    <div className="w-[220px] h-[71px] m-6">
