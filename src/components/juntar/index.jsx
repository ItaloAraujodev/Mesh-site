...
export default function Juntar() {
    return (
        <div id="juntar" className="w-full h-[50rem] 360:h-auto pb-1 bg-gradient-to-r from-line-linear-azul to-line-linear-red ">
            <div className="w-full h-full 360:py-10 bg-gradient-to-r from-azul-claro via-saturation-azul-escuro to-azul-claro text-white flex justify-center">
