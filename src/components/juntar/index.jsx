                ...
                <div className="flex flex-col justify-center items-center">
                    ...
                    <div className="w-full flex justify-center items-center gap-8">
                        {imgsJuntar.map((item, index) => (
                            <div key={index} className="w-[22%] h-[21rem] py-[2px] px-[2px] mt-12 rounded-[10px] bg-gradient-to-bl from-saturation-green to-saturation-azul-claro tra hover:bg-gradient-to-t hover:from-line-linear-azul hover:to-line-linear-rosa">
