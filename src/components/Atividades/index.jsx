                ...
                <div className='w-full h-2/3 flex flex-col'>
                    ...
                    <div className="w-full flex justify-center items-center gap-16 lg:gap-10 full:gap-[6rem]">
                        {atividades.map((item, index) => (
                            <div key={index} className="w-80 h-80 lg:w-72 lg:h-72 full:w-[20rem] full:h-[20rem] py-1 px-1 rounded-[57px] bg-gradient-to-bl from-saturation-green to-saturation-azul-claro">
