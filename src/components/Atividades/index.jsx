...
export default function Atividades() {
    return (
        <div id='atividade' className="w-full h-[50rem] pb-1 bg-gradient-to-r from-line-linear-azul to-line-linear-red ">
            <div className="w-full h-full bg-azul-claro text-white flex items-center justify-center">
