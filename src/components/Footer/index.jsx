...
export default function Footer(){
    return (
        ...
        <footer className="w-full h-[30rem] bg-[#0E192A] relative flex justify-center items-center">
            <div data-aos="zoom-in" className="w-3/4 h-[50%] sm:w-[90%] 360:h-auto 360:py-12 360:gap-8 sm:gap-12 md:gap-12 flex 360:flex-col sm:flex-row justify-center items-center bg-[#15213B] rounded-[20px]">
                <div className='flex text-white gap-10 sm:gap-4 md:gap-5'>
                    ...
                    <a href="https://twitter.com/MeshLabss" target='_blank' rel="noreferrer"><span className='text-3xl 360:text-xl hover:opacity-50'><AiOutlineTwitter /></span></a>
                </div>
