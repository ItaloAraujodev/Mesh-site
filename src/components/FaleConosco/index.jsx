    ...
    return (
        <section id='fale' className="w-full h-full text-white flex flex-col items-center py-24 360:h-auto relative bg-azul-claro">
            ...
            <div className='w-full h-full flex justify-center bg-saturation-preto 360:py-12 py-24  '>
                <div data-aos="fade-right" className='w-[70%] h-full grid grid-cols-2 items-stretch 360:grid-cols-1'>
                    <div className='my-auto'>
                        <img src={aviao} alt="Imagem de um avião de papel" className='object-cover' />
                    </div>

                    <div data-aos="fade-left" className='flex flex-col my-auto 360:text-center gap-10 360:w-[100%] h-auto 360:mt-10 md:w-[60%] md:ml-12 md:gap-8 xl:ml-16'>
                        <div>
                        ...
                        <div className='w-full flex gap-4 360:flex-col sm:flex-row 360:mx-auto md:flex-col'>
