...
export default function FaleConosco() {
    return (
        <section id='fale' className="w-full h-full text-white flex flex-col items-center py-24 360:h-auto relative bg-[#0E192A]">
            <h2 data-aos="zoom-in" className='text-[42px] font-russo-one font-white lg:text-[48px] 360:text-[2rem] mb-14 ' >Fale conosco</h2>
            <img src={ponto} alt="" draggable="false" className='absolute left-[4rem] top-36 360:invisible md:visible md:w-28 md:top-40' />
            <img src={ponto} alt="" draggable="false" className='absolute right-[3rem] bottom-6 rotate-180 md:visible 360:invisible md:w-28 md:bottom-10' />
            <div className='w-full flex justify-center bg-[#15213B] 360:py-12 py-24  '>
                <div data-aos="fade-right" className='w-[80%] h-full grid grid-cols-2 items-stretch 360:grid-cols-1 md:grid-cols-2'>
